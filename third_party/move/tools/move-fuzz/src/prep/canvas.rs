...
use crate::prep::{
    datatype::{MapVariant, TypeBase, TypeItem, VectorVariant},
...
impl From<SimpleType> for TypeBase {
    fn from(t: SimpleType) -> TypeBase {
        match t {
            ...
            SimpleType::I8 => TypeBase::I8,
            SimpleType::U16 => TypeBase::U16,
            SimpleType::I16 => TypeBase::I16,
            SimpleType::U32 => TypeBase::U32,
            SimpleType::I32 => TypeBase::I32,
            SimpleType::U64 => TypeBase::U64,
            SimpleType::I64 => TypeBase::I64,
            SimpleType::U128 => TypeBase::U128,
            SimpleType::I128 => TypeBase::I128,
            SimpleType::U256 => TypeBase::U256,
            SimpleType::I256 => TypeBase::I256,
...
impl From<TypeBase> for TypeClosureBase {
    fn from(t: TypeBase) -> TypeClosureBase {
        match t {
            ...
            TypeBase::I8 => TypeClosureBase::Simple(SimpleType::I8),
            TypeBase::U16 => TypeClosureBase::Simple(SimpleType::U16),
            TypeBase::I16 => TypeClosureBase::Simple(SimpleType::I16),
            TypeBase::U32 => TypeClosureBase::Simple(SimpleType::U32),
            TypeBase::I32 => TypeClosureBase::Simple(SimpleType::I32),
            TypeBase::U64 => TypeClosureBase::Simple(SimpleType::U64),
            TypeBase::I64 => TypeClosureBase::Simple(SimpleType::I64),
            TypeBase::U128 => TypeClosureBase::Simple(SimpleType::U128),
            TypeBase::I128 => TypeClosureBase::Simple(SimpleType::I128),
            TypeBase::U256 => TypeClosureBase::Simple(SimpleType::U256),
            TypeBase::I256 => TypeClosureBase::Simple(SimpleType::I256),
...
impl DriverCanvas {
    ...
    pub fn add_input_simple_recursive(&mut self, t: &SimpleType, depth: usize) -> DriverVariable {
        match t {
            ...
            SimpleType::I8 => self.new_param(BasicType::I8, depth),
            SimpleType::U16 => self.new_param(BasicType::U16, depth),
            SimpleType::I16 => self.new_param(BasicType::I16, depth),
            SimpleType::U32 => self.new_param(BasicType::U32, depth),
            SimpleType::I32 => self.new_param(BasicType::I32, depth),
            SimpleType::U64 => self.new_param(BasicType::U64, depth),
            SimpleType::I64 => self.new_param(BasicType::I64, depth),
            SimpleType::U128 => self.new_param(BasicType::U128, depth),
            SimpleType::I128 => self.new_param(BasicType::I128, depth),
            SimpleType::U256 => self.new_param(BasicType::U256, depth),
            SimpleType::I256 => self.new_param(BasicType::I256, depth),
            SimpleType::Bitvec => {
